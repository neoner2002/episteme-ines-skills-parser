        ...
        for (int i = 0; tables != null && i < tables.length; i++)
        {
            ...
            for (int j = 3; tableTR != null && j < tableTR.length; j++)
            {
                ...
                if(tableTD[1].getText().toString().trim().equals("1")){
                    company.isHigh = true; company.isMed = false; company.isLow = false;
                }
                if(tableTD[2].getText().toString().trim().equals("1")){
                    company.isMed = true; company.isHigh = false; company.isLow = false;
                }
                if(tableTD[3].getText().toString().trim().equals("1")){
                    company.isLow = true; company.isMed = false; company.isHigh = false;
                }
